 ...
 * Original file: /npm/@supabase/supabase-js@2.15.0/dist/umd/supabase.js
 *
    ...
    var e,
      ...
      r = {
              ...
              return (
                ...
                (l = function*() {
                  try {
                    ...
                    let f,
                      p = (null !== (r = u.headers.get("Content-Type")) &&
                      void 0 !== r
                        ? r
                        : "text/plain"
                      )
        ...
        165: (e, t, r) => {
          ...
          r.r(t),
            r.d(t, {
              AuthApiError: () => m,
              AuthError: () => v,
              AuthImplicitGrantRedirectError: () => S,
              AuthInvalidCredentialsError: () => E,
              AuthRetryableFetchError: () => T,
              AuthSessionMissingError: () => w,
              AuthUnknownError: () => b,
              CustomAuthError: () => _,
              GoTrueAdminApi: () => L,
              GoTrueClient: () => H,
          ...
          function g(e) {
            return y(e) && "AuthApiError" === e.name;
          }
          class b extends v {
            constructor(e, t) {
              super(e),
              ...
              O(void 0, void 0, void 0, function*() {
                ...
                "function" == typeof r.json
                  ? [502, 503, 504].includes(e.status)
                    ? t(new T(k(e), e.status))
                    : e
                        .json()
                        .then((r) => {
                          t(new m(k(r), e.status || 500));
                        })
                        .catch((e) => {
                          t(new b(k(e), e));
                        })
            ...
            signOut(e) {
              return D(this, void 0, void 0, function*() {
                try {
                  ...
                  if (y(e)) return { data: null, error: e };
                  throw e;
                }
              });
            }
            inviteUserByEmail(e, t = {}) {
              return D(this, void 0, void 0, function*() {
                try {
                  ...
                  if (y(e)) return { data: { user: null }, error: e };
                  throw e;
                }
              });
            }
            ...
            listUsers(e) {
              ...
              return D(this, void 0, void 0, function*() {
                try {
                  ...
                  if (y(e)) return { data: { users: [] }, error: e };
                  throw e;
                }
              });
            }
          ...
          const B = {
              ...
              headers: { "X-Client-Info": "gotrue-js/2.18.1" },
            },
            M = 1e4;
          class H {
            constructor(e) {
              ...
              if (
                ...
                (this.mfa = {
                  ...
                  getAuthenticatorAssuranceLevel: this._getAuthenticatorAssuranceLevel.bind(
                    this
                  ),
                }),
                i() &&
              ...
              return F(this, void 0, void 0, function*() {
                try {
                  ...
                  if ((yield this._removeSession(), "email" in e)) {
                    const { email: r, password: i, options: n } = e;
                    s = yield A(this.fetch, "POST", `${this.url}/signup`, {
                      headers: this.headers,
                    ...
                    {
                      const { phone: t, password: i, options: n } = e;
                      s = yield A(this.fetch, "POST", `${this.url}/signup`, {
                        headers: this.headers,
                        body: {
                          phone: t,
                  ...
                  return (
                    i.session &&
                      (yield this._saveSession(i.session),
            ...
            signInWithPassword(e) {
              ...
              return F(this, void 0, void 0, function*() {
                try {
                  let r;
                  if ((yield this._removeSession(), "email" in e)) {
                    const { email: t, password: s, options: i } = e;
                    r = yield A(
                      this.fetch,
                      "POST",
                    ...
                    {
                      const { phone: s, password: i, options: n } = e;
                      r = yield A(
                        this.fetch,
                        "POST",
                        `${this.url}/token?grant_type=password`,
                        {
                          ...
                          body: {
                            ...
                            channel:
                              null !== (t = null == n ? void 0 : n.channel) &&
                              void 0 !== t
                                ? t
                                : "sms",
                          },
            ...
            refreshSession(e) {
              ...
              return F(this, void 0, void 0, function*() {
                try {
                  ...
                  if (!(null == e ? void 0 : e.refresh_token)) throw new w();
            ...
            _getSessionFromUrl() {
              return F(this, void 0, void 0, function*() {
                try {
                  if (!i()) throw new S("No browser detected.");
                  if (!this._isImplicitGrantFlow())
                    throw new S("Not a valid implicit grant flow url.");
                  const e = a("error_description");
                  if (e) {
                    const t = a("error_code");
                    if (!t) throw new S("No error_code detected.");
                    const r = a("error");
                    if (!r) throw new S("No error detected.");
                    throw new S(e, { error: r, code: t });
                  }
                  const t = a("provider_token"),
                    r = a("provider_refresh_token"),
                    s = a("access_token");
                  if (!s) throw new S("No access_token detected.");
                  const n = a("expires_in");
                  if (!n) throw new S("No expires_in detected.");
                  const o = a("refresh_token");
                  if (!o) throw new S("No refresh_token detected.");
                  const h = a("token_type");
                  if (!h) throw new S("No token_type detected.");
                  const l = Math.round(Date.now() / 1e3) + parseInt(n),
                    { data: c, error: u } = yield this.getUser(s);
                  if (u) throw u;
                  const d = c.user,
                    f = {
                      provider_token: t,
            ...
            signOut() {
              ...
              return F(this, void 0, void 0, function*() {
                ...
                if (s) {
                  ...
                  if (e && (!g(e) || (404 !== e.status && 401 !== e.status)))
                    return { error: e };
                }
                return (
                  yield this._removeSession(),
            ...
            _callRefreshToken(e) {
              ...
              return F(this, void 0, void 0, function*() {
                ...
                try {
                  if (((this.refreshingDeferred = new d()), !e)) throw new w();
                ...
                if (
                  ...
                  const i = yield (function(e) {
                    ...
                    n = new URLSearchParams({
                      flow_type: `${encodeURIComponent(t.flowType)}`,
        ...
        189: (e, t, r) => {
          ...
          const l = { "X-Client-Info": "postgrest-js/1.4.1" };
          class c {
            constructor(e, { headers: t = {}, schema: r, fetch: s } = {}) {
              (this.url = e),
        ...
        73: (e, t, r) => {
          ...
          var s = r(840);
          const i = { "X-Client-Info": "realtime-js/2.7.1" };
          var n, o, a, h, l, c, u;
          !(function(e) {
        ...
        752: (e, t, r) => {
          ...
          const w = { "X-Client-Info": "storage-js/2.4.0" };
